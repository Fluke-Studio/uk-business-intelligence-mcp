...
export const metadata: Metadata = {
  title: 'Cognism Alternative — UK Business Data from £0/month | UK Business Intel',
  description:
    'Looking for a Cognism alternative? UK Business Intelligence API provides UK company data from £0/month instead of $15,000+/year. Self-serve signup, no sales call.',
  openGraph: {
    title: 'Cognism Alternative — From £0/month, Not $15K/year',
    description: 'UK business data with Companies House records, Google reviews, website health, and social media. Self-serve API from £0/month.',
    type: 'website',
    locale: 'en_GB',
  },
  alternates: { canonical: 'https://ukbusinessintel.com/compare/cognism-alternative' },
};
...
const features = [
  ...
  { feature: 'Social Media Discovery', us: true, them: true },
  { feature: 'Direct Dial Phone Numbers', us: false, them: true },
  { feature: 'Email Addresses', us: false, them: true },
  { feature: 'Global B2B Data (non-UK)', us: false, them: true },
...
export default function CognismAlternativePage() {
  return (
    <div className="min-h-screen bg-zinc-950 text-white font-[family-name:var(--font-geist-sans)] overflow-x-hidden w-full">
      ...
      <div className="pt-24 px-6"><div className="max-w-5xl mx-auto">
        <nav aria-label="Breadcrumb" className="text-xs text-zinc-500">
          ...
          <span className="text-zinc-300">Cognism Alternative</span>
        </nav>
      </div></div>
      ...
      <section className="pt-6 pb-12 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-emerald-500/10 text-emerald-400 text-xs font-medium px-3 py-1.5 rounded-full mb-6 border border-emerald-500/20">
            From &pound;0/month, not $15,000/year
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
            Cognism Alternative for
            <br /><span className="text-emerald-400">UK Business Data</span>
          </h1>
          <p className="text-lg text-zinc-400 max-w-3xl leading-relaxed">
            Cognism charges $15,000+/year with annual contracts. If you need UK company
            verification and enrichment &mdash; not global B2B contact data &mdash; you can get
            started for free and pay as you grow.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 pb-12">
        <div className="max-w-5xl mx-auto grid sm:grid-cols-2 gap-6">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
            <p className="text-sm text-zinc-500 uppercase tracking-wide font-medium mb-2">Cognism</p>
            <p className="text-3xl font-bold text-zinc-300">$15,000+</p>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden overflow-x-auto">
            <table className="w-full text-sm min-w-[500px]">
              <thead><tr className="border-b border-zinc-800">
                ...
                <th className="text-center px-4 py-3 text-zinc-500 font-medium text-xs uppercase tracking-wide">Cognism</th>
              </tr></thead>
      ...
      <section className="px-6 pb-12">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-xl font-bold mb-4">When to Choose Cognism Instead</h2>
          <div className="space-y-4 text-sm text-zinc-400 leading-relaxed">
            <p>Cognism is the better choice if you need:</p>
            <ul className="list-disc list-inside space-y-2">
              <li><strong className="text-zinc-300">Direct dial phone numbers</strong> &mdash; Mobile-verified contact data for sales outreach</li>
              <li><strong className="text-zinc-300">Global B2B data</strong> &mdash; Coverage beyond the UK across EMEA and North America</li>
              <li><strong className="text-zinc-300">Intent data</strong> &mdash; Know which companies are researching your category</li>
              <li><strong className="text-zinc-300">CRM integration</strong> &mdash; Native Salesforce and HubSpot connectors</li>
            </ul>
            <p>If your focus is UK company verification and enrichment at an affordable price point, we&apos;re a fraction of the cost with data sources Cognism doesn&apos;t offer (Google reviews, website health, SSL checks).</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 pb-20">
        <div className="max-w-3xl mx-auto">
          <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-xl p-6 sm:p-8 text-center">
            <h2 className="text-xl sm:text-2xl font-bold mb-3">Start for Free, Not $15K</h2>
            <p className="text-zinc-400 text-sm mb-6">100 free lookups per month. No annual contract. No sales call. See the data yourself.</p>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Cognism Alternative', item: 'https://ukbusinessintel.com/compare/cognism-alternative' },
      ] }) }} />
